...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/tempus-dominus.min.css"/>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/tempus-dominus.min.js"></script>
